...
/**
 * ลบข้อมูลผู้ตอบกิจกรรมสดออกจากเครื่อง
 * ใช้คู่กับปุ่ม Reset ข้อมูล เพราะข้อมูลชุดนี้เก็บคนละคีย์กับข้อมูลคู่
 * ถ้าไม่ลบด้วย ห้องเดิมจะค้างอยู่ แล้วผู้เรียนคาบถัดไปจะไม่เห็นโจทย์
 * ทั้งที่หน้าเริ่มต้นใช้งานกรอกห้องใหม่ถูกต้องแล้ว
 */

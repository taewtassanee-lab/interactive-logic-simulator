...
export interface WorksheetData {
  ...
  q4Extend: string;
  /**
   * ย้ายตรรกะเดิมไปใช้กับโจทย์คนละบริบท (ระบบสุ่มชื่อนักเรียนไม่ซ้ำ)
   * เป็นหลักฐานของตัวชี้วัดที่ 5 ข้อ 3 ประยุกต์ใช้ทักษะในสถานการณ์ใหม่
   * แยกจาก q4Extend โดยเจตนา เพราะ q4Extend คือการต่อยอด "ระบบเดิม"
   * ส่วนข้อนี้คือการถ่ายโอนตรรกะไป "ระบบอื่น" ซึ่งเป็นคนละระดับการคิด
   */
  q5Transfer: string;
}

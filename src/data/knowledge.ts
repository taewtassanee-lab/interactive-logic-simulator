 ...
 */
/**
 * ชุดข้อสอบ 10 ข้อในรูปแบบ JSON ของ Construct 2 สำหรับวางในแอ็กชัน Load from JSON string
 *
 * ต้องมีไว้ในระบบ เพราะแผนกำหนดให้ผู้เรียนเขียนบล็อกนี้เองในคาบ
 * แต่ไม่มีที่ใดบอกว่าข้อความ JSON มาจากไหน ถ้าปล่อยให้พิมพ์เองจะเสียเวลาและพิมพ์ผิดง่าย
 * เพราะเป็นข้อความยาวที่วงเล็บและเครื่องหมายคำพูดต้องครบถ้วนทุกตัว
 *
 * รูปแบบข้อมูลในแต่ละช่องคือ "หมายเลขข้อ,ตัวเฉลย" ซึ่งตรงกับที่อธิบายไว้ในหัวข้อ tokenat
 */
export const QUIZ_JSON =

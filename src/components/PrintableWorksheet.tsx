  ...
  ({ state }, ref) => {
    ...
    return (
      <div ref={ref} style={S.page}>
        ...
        {/* หลักฐานตัวชี้วัดที่ 5 ข้อ 3 ต้องปรากฏใน PDF ที่ผู้เรียนส่ง จึงพิมพ์ออกมาด้วย */}
        <p style={S.qLabel}>
          ถ้าครูอยากได้ระบบสุ่มชื่อนักเรียนขึ้นมาตอบคำถามหน้าชั้น โดยไม่ให้ซ้ำคนเดิมจนกว่าจะครบทุกคน
          เราจะใช้ตรรกะเดียวกับที่เรียนวันนี้อย่างไร
        </p>
        <div style={S.answer}>{show(worksheet.q5Transfer)}</div>

        ...
        >
          <div className="clay-card w-full max-w-md animate-pop p-5">
            ...
            <p className="text-sm leading-relaxed text-slate-600">
              ระบบจะลบข้อมูลผู้เรียน บล็อกใน Workspace ผลภารกิจ คำตอบในใบงาน
              และชื่อกับห้องที่ลงทะเบียนไว้ในกิจกรรมสด ทั้งหมดที่บันทึกไว้ในเบราว์เซอร์นี้
              การกระทำนี้ย้อนกลับไม่ได้
            </p>
            <p className="mt-2 text-xs leading-relaxed text-slate-500">
              ใช้ปุ่มนี้เมื่อเปลี่ยนห้องเรียนที่ใช้เครื่องนี้ เพื่อไม่ให้ห้องเดิมค้างอยู่
              ซึ่งจะทำให้ผู้เรียนห้องใหม่ไม่เห็นโจทย์ในกิจกรรมสด
            </p>

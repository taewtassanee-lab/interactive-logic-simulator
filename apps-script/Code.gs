...
/** รหัสสำหรับให้เว็บแอปของนักเรียนส่งข้อมูลเข้ามา (ตั้งเป็นอะไรก็ได้ ห้ามเว้นว่าง) */
const CLASS_SECRET = 'CHANGE_ME_CLASS';

/** รหัสสำหรับให้ครูเปิดดูแดชบอร์ด (ตั้งให้ต่างจากรหัสด้านบน และห้ามบอกนักเรียน) */
